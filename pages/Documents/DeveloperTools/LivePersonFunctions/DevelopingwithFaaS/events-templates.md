...
|Messaging Consumer Step Up|Triggered when a consumer does a step up, when they create a conversation without first authenticating, but then authenticate.<br/>For more details on how to set up a function like this one, please see details [here](liveperson-functions-integrations-messaging-conversations.html).|ControllerBot|1|
