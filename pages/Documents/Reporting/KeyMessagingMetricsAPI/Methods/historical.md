...
The trends API retrieves messaging metrics over time filtered by agent, group or skill, for a time window of up to 24 hours in a sliding window of the last 30 days.
