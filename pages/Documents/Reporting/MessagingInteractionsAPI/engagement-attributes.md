...
1. v1 — will allow to retrieve authenticated engagement attributes only and their attribute type will be alphanumeric.
2. v2 — will allow to retrieve both authenticated and unauthenticated engagement attributes and their type will be the defined type for the engagement attribute in question.
