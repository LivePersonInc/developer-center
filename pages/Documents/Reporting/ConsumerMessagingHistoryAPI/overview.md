...
2. This API requires authorization using a JWT token passed in the authorization header of the request. Please see our [authentication](guides-authentication-introduction.html) and [token creation documentation](consumer-int-getting-started.html) for more information.

3. Note the [API terms of use](https://www.liveperson.com/policies/apitou).

### Use cases

This is a complementary API for the [Messaging Window API](consumer-int-overview.html). It should be used to retrieve historical conversations when using the Messaging Window API for its [various use cases and scenarios](messaging-window-api-overview.html#use-cases).