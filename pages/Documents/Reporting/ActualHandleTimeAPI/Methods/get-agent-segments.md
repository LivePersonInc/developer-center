...
| segmentDeatils        | Description of the events in the segment      | Container                                                        | Phase 2 API                                                                                                                          |
| eventSequence         | Event sequence number                         | string                                                           | Phase 2 API                                                                                                                          |
| eventStartReason      | Event measurement trigger                     |                                                                  | Phase 2 API                                                                                                                          |
| EventEndReason        | Event end measurement trigger                 |                                                                  | Phase 2 API                                                                                                                          |
| eventStartTime        | Event start timestamp                         | [RFC 3339](https://tools.ietf.org/html/rfc3339) date-time string | Phase 2 API                                                                                                                          |
| eventEndTime          | Event end timestamp                           | [RFC 3339](https://tools.ietf.org/html/rfc3339) date-time string | Phase 2 API                                                                                                                          |
| eventHandleTime       | Toal time in milliseconds from start to end   | Numeric                                                          | Phase 2 API                                                                                                                          |
