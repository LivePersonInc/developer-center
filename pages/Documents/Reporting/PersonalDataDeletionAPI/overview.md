...
<div class="note">As the Ticketing system is a legacy feature used by legacy (non LE 2.0) accounts, this API requires authorization using an external OAuth 1.0 API key. <b>This token should be generated by the LivePerson Support team</b>.</div>
