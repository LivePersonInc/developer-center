...
If you want to allow consumers to download the app from PlayStore, even if their devices doesn't support Audio latency, please add below features in your app's manifest file:
