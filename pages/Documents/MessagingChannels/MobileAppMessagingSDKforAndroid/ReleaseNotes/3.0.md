...
<thead>
 ...
 <td><img loading="lazy" src="img/android_sticky_timestamp_text_size.png" alt=""></td>
 </tr>
 <tr>
 <td>&lt;dimen name="sticky_timestamp_margin_top">8dp</dimen></td>
 <td>Defines the Date Separator top spacing.</td>
 <td><img loading="lazy" src="img/android_sticky_timestamp_margin_top.png" alt=""></td>
 </tr>
 <tr>
 ...
 <td><img loading="lazy" src="img/android_avatar_margin_leading.png" alt=""></td>
 </tr>
 <tr>
 ...
 <td><img loading="lazy" src="img/android_avatar_margin_trailing.png" alt=""></td>
 </tr>
 <tr>
 <td>
 ...
 <td><img loading="lazy" src="img/android_enter_message_top_separator_color.png" alt=""></td>
 </tr>
 <tr>
 ...
 <td><img loading="lazy" src="img/android_enter_message_divider_visible.png" alt=""></td>
 </tr>
 <tr>
 ...
 <td><img loading="lazy" src="img/android_bubble_system_resolved_text_size.png" alt=""></td>
 </tr>
 <tr>
 <td>&lt;dimen name="bubble_system_resolved_padding"&gt;@dimen/margin_half</dimen></td>
 <td>Defines the Resolved system message padding.</td>
 <td><img loading="lazy" src="img/android_bubble_system_resolved_padding.png" alt=""></td>
 </tr>
 <tr>
 <td>&lt;dimen name="bubble_system_resolved_line_spacing">0dp</dimen>
</td>
 <td>Defines the Resolved system message line spacing.</td>
 <td><img loading="lazy" src="img/android_bubble_system_resolved_line_spacing.png" alt=""></td>
 </tr>
 <tr>
 ...
 <td><img loading="lazy" src="img/android_bubble_system_resolved_separator_padding_bottom.png" alt=""></td>
 </tr>
 <tr>
 ...
 <td><img loading="lazy" src="img/android_lp_progress_bar_image.png" alt=""></td>
 </tr>
 </tbody>
</table>
