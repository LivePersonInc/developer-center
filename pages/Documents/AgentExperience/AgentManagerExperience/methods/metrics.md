...
|metricsToRetrieveCurrentValue | List of metrics retrieving the current value, not influenced by time | Array `<String>` | Optional | Valid values:<br/>assigned_conversations<br/>agent_load<br/>human_agent_load<br/>human_online_load<br/>online_agents<br/>back_soon_agents<br/>away_agents<br/>available_slots
