...
{: .attn-note}
The below tutorials assume that you have performed the initial steps required in order to work with this API, which can be found [here](/messaging-window-api-getting-started.html).
