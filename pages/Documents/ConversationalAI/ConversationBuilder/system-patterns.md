...
3. In your bot, get the user’s name and store it in a bot variable. Then use the command in a text interaction like so:
    ...
    <img loading="lazy" class="fancyimage" style="width:600px" src="img/ConvoBuilder/system_patterns1.png" alt="An example of using SET_USER_PROFILE in a Text statement">
