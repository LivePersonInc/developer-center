...
3. Specify the following:
    ...
    * **Environment Values**: Enter the key/value pairs for each variable. Variables *cannot* have spaces or special characters in their names, only letters and numbers.
    ...
    <img loading="lazy" class="fancyimage" style="width:700px" src="img/ConvoBuilder/bestPractices/env_1.png" alt="The Add Environment window">
...
1. Open the bot, and click <img loading="lazy" style="width:30px" src="img/ConvoBuilder/icon_ellipsisVertical.png" alt="Three-doct icon"> (3-dot icon) in the upper-left corner, just to the right of the menu bar.
...
<img loading="lazy" style="width:700px" src="img/ConvoBuilder/bestPractices/env_6.png" alt="An example of using an environment variable in a Text statement, and a view of how it renders to the consumer">
...
3. In the right panel, under **More Options**, click <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_envVariables_download.png" alt="Download icon"> (Download icon) beside **Export Environment Variables**.
