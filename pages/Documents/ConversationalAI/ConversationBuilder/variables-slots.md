...
* **Forever**: The data will be saved and accessible by the bot for 180 days. **Note**: The "Forever" option will be deprecated in a future release. Use of the [Conversation Context Service](conversation-builder-scripting-functions-manage-the-conversation-context-service.html) instead of this option is recommended.
