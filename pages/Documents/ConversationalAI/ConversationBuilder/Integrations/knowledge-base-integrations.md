...
2. Configure the integration settings (required fields are marked with asterisks):
    ...
    - **Request Parameters for a Phrase search**:
        - *mode*: Select either Intents, Intents Only, or All. For a description of each mode, see [here](knowledge-base-common-common-concepts.html#knowledge-base-searches).
