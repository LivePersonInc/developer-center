...
<img loading="lazy" class="fancyimage" style="width:800px" src="img/ConvoBuilder/templates_ghf1.png" alt="The Global Functions page in a bot created from the Global Helper Functions bot template">
