...
* **Resume Conversation**: Reopens the conversation.
...
Auto update on - keeps fetching the latest logs
On/off
if don't need the info, turn off to keep the connection clean
