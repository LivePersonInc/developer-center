...
<img loading="lazy" class="fancyimage" style="width:1000px" src="img/ConvoBuilder/botGroups_dashboard.png" alt="The Bots dashboard with several key features highlighted">
...
5. Click the <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_ellipsis_vertical_light.png" alt="Three-dot icon"> icon to access the group menu, which provides options for editing and deleting the group.
...
1. From the bots dashboard that lists your bots, click the <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_ellipsis_vertical_light.png" alt="Three-dot icon"> icon that corresponds to the bot group name.
...
<img loading="lazy" class="fancyimage" style="width:1000px" src="img/ConvoBuilder/botGroups_unassigned.png" alt="The Ungrouped bots section on the Bots dashboard">
