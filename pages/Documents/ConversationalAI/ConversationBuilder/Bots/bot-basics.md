...
1. Open the bot, and click <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_ellipsisVertical.png" alt="Three-dot icon"> (3-dot icon) in the upper-left corner, just to the right of the menu bar.
...
1. If you logged into Conversation Builder directly (i.e., _not_ via single sign-on from Conversational Cloud) and you have access to multiple organizations within your Conversational Cloud account, verify in the upper-right corner that the organization under which the bot should exist is displayed. If it isn’t displayed, select it from the **Org** Name dropdown list.
    ...
    <img loading="lazy" class="fancyimage" style="width:200px" src="img/ConvoBuilder/org_selection.png" alt="Org dropdown selector">
...
1. Open the bot, and click <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_ellipsisVertical.png" alt="Three-dot icon"> (3-dot icon) in the upper-left corner, just to the right of the menu bar.
2. Select **Bot Settings**.
3. Click **More Settings**, and then click the **Export Bot** icon <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_export.png" alt="Export Bot">.
...
1. Open the bot, and click <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_ellipsisVertical.png" alt="Three-dot icon"> (3-dot icon) in the upper-left corner, just to the right of the menu bar.
2. Select **Bot Settings**.
3. Click **More Settings**, and then click the **Delete Bot** icon <img loading="lazy" style="width:25px" src="img/ConvoBuilder/icon_delete.png" alt="">.
