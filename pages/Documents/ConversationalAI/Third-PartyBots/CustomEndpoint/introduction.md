...
You can also use `App Installation` selector to fill-out the `Client ID` and`Client Secret` fields.
If the selector is has no App Installations, then you have to do a Custom Endpoint
