...
<img loading="lazy" style="width:600px" src="img/botconnectordashboard/campaign_manager_bot_permissions.png" alt="">

Minimal set of permissions for creating and starting bots for Campaign Manager Profile

<img loading="lazy" style="width:600px" src="img/botconnectordashboard/administrator_bot_permissions.png" alt="">
...
1. Add a new user in the Conversational Cloud. Choose "Bot" for “User type”. If bot is not available as a user type, contact your LivePerson account manager to enable the feature.
  ...
  <img loading="lazy" style="width:600px" src="img/ThirdPartyBots/common-create-bot-user.png" alt="">

{:start="2"}

1. Under login method, choose "API key" and generate a new API key for the user

   <img loading="lazy" style="width:600px" src="img/ThirdPartyBots/common-create-api-key.png" alt="">
...
1. Find the API key name you created above the in bot user profile
   ...
   <img loading="lazy" style="width:400px" src="img/ThirdPartyBots/common-find-api-key.png" alt="">
...
<img loading="lazy" class="fancyimage" style="width:750px" src="img/botconnectordashboard/conversational_ai_app.png" alt="">
...
2. Click “+ Add Bot” in the bot table
   ...
   <img loading="lazy" style="width:800px" src="img/botconnectordashboard/add_new_bot.png" alt="">
