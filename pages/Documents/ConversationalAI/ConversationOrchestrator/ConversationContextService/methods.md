...
REST APIs can directly access the CCS within our outside Conversational Cloud. Use the REST APIs when you want to retrieve information from external data sources.
