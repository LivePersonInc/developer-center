...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting1.png" alt="The Write an expression tab in the expression editor">
...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting2.png" alt="An example expression">
...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting3.png" alt="An example expression using custom variables">
...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting4.png" alt="Using predefine templates to create a routing policy">

Add the required template to the editor.

<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting5.png" alt="The template added to the policy">
...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting6.png" alt="An example expression using date and time with other attributes">
...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting7.png" alt="Using the policy logs to debug policies">
...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_advrouting8.png" alt="An example of a complex condition that nests multiple expressions">
...
<img loading="lazy" width="800" src="img/convorchestrator/co_dr_advrouting9.png" alt="The architectural diagram illustrating the flow between the components involved">
...
<img loading="lazy" width="800" src="img/convorchestrator/co_dr_advrouting10.png" alt="The architectural diagram illustrating the flow between the components involved">
