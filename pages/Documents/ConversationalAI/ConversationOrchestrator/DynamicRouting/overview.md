...
<img loading="lazy" class="fancyimage" width="800" src="img/convorchestrator/co_dr_components.png" alt="An architectural diagram that illustrates the various components that work together to perform dynamic routing">
