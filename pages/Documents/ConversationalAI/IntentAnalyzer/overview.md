...
documentname: LivePerson Intent Analyzer
permalink: LivePerson-intent-analyzer-overview.html
indicator: both
Redirect from: intent-analyzer-overview.html
- 
---
### Overview

LivePerson's Intent Analyzer is the hub for tracking and maintaining intents in real time. It provides enhanced reporting and analytics for your bots and automation.
