...
Starting on October 18, 2020, the number of articles that can be added to an internal knowledge base is limited to 250 or fewer. Internal knowledge bases created before this time are exempt from this limit. However, for an optimal consumer experience, brands are encouraged to design solutions that follow the best practices outlined here below.
...
{: .important}
If you're using [domain intents](knowledge-base-internal-knowledge-bases-introduction.html#domain-intents-versus-knowledge-base-intents) (not knowledge base intents), the same guidelines apply.
