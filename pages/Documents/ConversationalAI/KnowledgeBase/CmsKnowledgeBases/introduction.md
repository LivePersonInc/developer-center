...
* [Without using LivePerson AI](knowledge-base-cms-knowledge-bases-cms-kbs-without-liveperson-ai.html). In this case, the knowledge base uses the CMS' query and answer API for article selection.
