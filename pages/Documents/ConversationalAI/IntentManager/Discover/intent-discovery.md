...
<img loading="lazy" class="fancyimage" style="width:800px" alt="Dropdown for classifying a message, assigning it to an intent" src="img/ConvoBuilder/im_intent_discovery3g.png">
