...
Stop words are words that are not used by the NLU engine to score an utterance. These words are essentially removed or ignored in the intent matching process. Below is the list of the stop words:
