...
* Google Dialogflow or IBM Watson engine - See [here](intent-manager-natural-language-understanding-google-dialogflow-and-ibm-watson-nlu-engines.html#train-a-domain).
* External, Rasa-based engine - See [here](intent-manager-natural-language-understanding-external-rasa-based-nlu-engine.html#train-a-domain).
