...
<img loading="lazy" class="fancyimage" alt="Top of Edit Profile page in Conversational Cloud" style="width:700px" src="img/ConvoBuilder/permissions2.png">

<img loading="lazy" class="fancyimage" alt="Bottom of Edit Profile page in Conversational Cloud" style="width:700px" src="img/ConvoBuilder/permissions3.png">

You can then assign this profile to users like so:

<img loading="lazy" class="fancyimage" alt="Adding a profile to the Assignment field on the Edit user page" style="width:650px" src="img/ConvoBuilder/permissions4.png">
...
<img loading="lazy" class="fancyimage" alt="List of Conversation Builder add-on permissions in Conversational Cloud" style="width:700px" src="img/ConvoBuilder/permissions1.png">
