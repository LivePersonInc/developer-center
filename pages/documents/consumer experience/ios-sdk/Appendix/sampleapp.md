...
2. Once you have your configuration object you simple call the predefine customization methods like this:
...
6. Make sure the **Push Notification** services are **Enabled** or **Configurable**
    > Note: if the services appear as **Configurable**, that means you'll need to create the corresponden **Certificate**
    > depending on your needs **Development** or **Production**.
