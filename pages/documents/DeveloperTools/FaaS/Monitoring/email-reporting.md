...
<tbody>
  <tr>
    ...
    <td>-</td>
    <td>No report will be send - you can use this for pausing the schedule of the report</td>
  </tr>
  <tr>
    <td style="width:120px">Daily</td>
    <td>Every day at 2am UTC</td>
    <td>The report will include the statistics of the day before</td>
  </tr>
  <tr>
    <td style="width:120px">Weekly</td>
    <td>Every monday at 2am UTC</td>
    <td>The report will include the statistics of the week before (monday to sunday)</td>
  </tr>
</tbody>
</table>
<div class="important">If you setup the report the first time, it will be send to you on the next full hour (e.g. 10:00am)</div>
