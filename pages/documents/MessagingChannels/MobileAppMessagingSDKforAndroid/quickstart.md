...
- [Configure push notifications](mobile-app-messaging-sdk-for-android-appendix-use-the-liveperson-sdk-android.html#step-5---configure-push-notifications). Push and local notifications are a key factor that makes the experience better for consumers - they never have to stay in your app or keep the window open as they will get a proactive notification as soon as a reply or notice is available.
