...
4. Connect to your account via LiveEngage, click on the **Campaigns** tab, and then choose **Data Sources**.
...
5. On the Mobile app management tab, click **Manage**.

6. Click **Add new** to add your app to the mobile campaign.

7. Enter your mobile package name and the Google Firebase Legacy API key, then click **Create app**.
