...
{: .note}
NOTE: iOS SDK 3.7 compatibility with XCode 10.2, Swift 5 will be released as 3.7.1 on or before April 5 2019. 
...
<pre class="language-swift"><code>public class func resolveConversationForConversationQuery(_ conversationQuery: ConversationParamProtocol)</code></pre>
