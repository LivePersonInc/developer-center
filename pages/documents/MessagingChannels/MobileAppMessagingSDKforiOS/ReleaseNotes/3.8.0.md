...
iOS Mobile App SDK v3.8 is compatible with XCode 10.2, Swift version 5.0 (swiftlang-1001.0.69.5 clang-1001.0.46.3) and is supported on iOS versions 10 through 12.
...
- By default, eight quick replies are presented per row, which is a fixed value, and quick replies styles inherit the Agent Bubble styling configuration.
