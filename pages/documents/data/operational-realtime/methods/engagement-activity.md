...
| totalNonInteractiveChats | The number of non-interactive chats were closed in the current interval/time frame (this includes also chats that were abandoned by the visitor). | long |
