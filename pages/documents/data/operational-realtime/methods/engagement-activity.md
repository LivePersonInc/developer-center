...
| totalNonInteractiveChats | The number of non-interactive chats were closed in the current interval/time frame (this include also chats that were abandon by the visitor). | long |
