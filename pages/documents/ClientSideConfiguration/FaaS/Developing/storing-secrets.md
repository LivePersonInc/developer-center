...
The FaaS Secrets Storage allows you to centrally store, access and distribute secrets across your lambdas. Thereby lambdas can use available access tokens, certificates & encryption keys to establish a connection to external systems.
