...
| imageURL | Image to be placed in the List Picker received and reply message layout | String | N | JPG and PNG Only <br/> Up to 0.5Mb of total images size in the list picker |
