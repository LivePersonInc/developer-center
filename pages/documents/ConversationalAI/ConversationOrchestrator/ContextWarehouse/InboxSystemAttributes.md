...
Inbox system attributes are available out of the box from the LivePerson platform. To view the list of available attributes, please login to Conversation Orchestrator using your LiveEngage credentials, and then navigate to Context Warehouse/Conversation. 
