...
* For performance reasons:
    ...
    * Supports a maximum of 20 positive learnings per Knowledge Base article (applicable when using [domain intents](knowledge-base-overview.html#knowlege-base-intents-versus-domain-intents)). There is no limit on the number of negative learnings; however, see the best practices discussed [here](knowledge-base-articles.html#best-practices).
