...
* **Interaction Delay**: Set the millisecond time delay before sending this message. Enter a maximum value of 10 seconds (10000 milliseconds). If you enter a lower value, the value that you enter is used. If you enter 10000 or greater, 10000 is used.
