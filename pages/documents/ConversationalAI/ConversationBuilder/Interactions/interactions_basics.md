...
### Whitelisting
The domains in all URLs for images, videos, and audio files used in interactions must be whitelisted. Contact your LivePerson representative to assist with this.

### Add an interaction
**To add a new interaction to the end of the dialog**

- Click <img style="width:25px" src="img/ConvoBuilder/btn_newInteraction.png">, which appears below the last interaction, and then select the interaction icon from the toolbar that appears.
...
1. Select the interaction.
2. Move your mouse over its upper-left corner until <img style="width:25px" src="img/ConvoBuilder/icon_interactionMove.png"> (Move icon) appears.
...
1. Select the interaction, and click <img style="width:25px" src="img/ConvoBuilder/icon_interactionDetails.png"> (Interaction Details).
