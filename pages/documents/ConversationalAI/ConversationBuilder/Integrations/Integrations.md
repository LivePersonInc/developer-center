...
Want some practice with integrations? The [Integrations tutorial](conversation-builder-getting-started-3-integrations.html) provides a walkthrough of adding one. You'll need to complete the [Dialogs and Patterns tutorial](conversation-builder-getting-started-1-dialogs-and-patterns.html) and the [Intents tutorial](conversation-builder-getting-started-2-intents.html) first, as they build on each other.
...
- **File**: Use a File integration to take a file that was uploaded by the consumer to LiveEngage via a [File Upload interaction](conversation-builder-interactions-integrations.html#file-upload-integrations) and upload it to your external file share or system. See [here](conversation-builder-integrations-file-integrations.html) for more.
- **FaaS**: Use a FaaS integration to invoke a function (`lambda`) that is deployed to the [LivePerson Functions](liveperson-functions-overview.html) (Function as a Service or FaaS) platform. There are no constraints here; if there is some custom logic (a function) you want to invoke with a bot, you can do it with a FaaS integration. See [here](conversation-builder-integrations-liveperson-functions-integrations.html) for more.
