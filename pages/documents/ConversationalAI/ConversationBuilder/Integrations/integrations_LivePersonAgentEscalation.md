...
2. Configure the integration settings (required fields are marked with asterisks):
    ...
    - **Agent Id**: Optional. Specify the ID (login name) of the human agent or the bot ID of the bot to which to transfer the conversation. (The bot ID can be obtained from a bot's [bot settings](conversation-builder-bots-bot-basics.html#configure-bot-settings).)
