...
2. Configure the integration settings (required fields are marked with asterisks):
    ...
    - **Bot Transfer Context**: Used for bot-to-bot escalations (transfers) only. Select this to *automatically* pass the conversational context--the intent and/or user message--from the sender bot to the receiver bot. This lets the receiver bot know the appropriate dialog to start after the transfer. For more information, see the discussion on bot-to-bot transfers [here](conversation-builder-bots-bot-to-bot-transfers.html).
