...
2. Configure the integration settings (required fields are marked with asterisks):
    ...
    - **Agent Skill Name**: Enter the name of the agent skill to which to transfer the conversation. The skill is defined in LiveEngage. Entering the name provides you with something display-friendly and "readable" by which to readily understand which skill is being used.
    ...
    - **Agent Id**: Optional. This option is applicable only for bot-to-bot transfers, **not** for bot-to-live agent transfers. Enter the ID of the bot to which to transfer the conversation. The bot ID can be obtained from a bot's [bot settings](conversation-builder-bots-bot-basics.html#configure-bot-settings).
