...
* **Forever**: The data will be saved and accessible by the bot for 180 days. **Note**: Use of the [Context Session Store](conversation-builder-scripting-functions-manage-the-context-session-store.html) instead of this option is recommended. The "Forever" option will be deprecated in a future release.
