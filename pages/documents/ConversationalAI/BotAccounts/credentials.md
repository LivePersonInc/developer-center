...
Additionally, if you're using a third-party NLU engine to match intents, you can use the [Fire API credential type](bot-accounts-credentials.html#add-a-fire-api-credential) to authenticate with the third-party engine.
