...
var url = 'https://{YOUR BASE URI}/api/account/{YOUR ACCOUNT NUMBER}/configuration/le-users/agentGroups?v=1';
request.get({
    url: url,
    oauth: oauth,
    json: true,
...
url = 'https://{YOUR BASE URI}/api/account/{YOUR ACCOUNT NUMBER}/configuration/le-users/agentGroups/{AGENT GROUP ID}?v=1';
request.get({
    url: url,
    oauth: oauth,
    json: true,
