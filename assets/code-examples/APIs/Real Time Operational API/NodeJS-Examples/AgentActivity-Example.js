...
// Query the API
// Example URL: https://va-a.data.liveperson.net/operations/api/account/56072331/agentactivity?timeframe=1440&agentIds=all&v=1
var url = 'https://{YOUR BASE URI}/operations/api/account/{YOUR ACCOUNT NUMBER}/agentactivity?timeframe=1440&agentIds=all&v=1';
