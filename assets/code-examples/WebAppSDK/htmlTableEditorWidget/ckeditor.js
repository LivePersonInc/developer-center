...
*/
  ...
  CKEDITOR.plugins.add("dialog", { requires: "dialogui", init: function (x) { x.on("doubleclick", function (A) { A.data.dialog && x.openDialog(A.data.dialog) }, null, null, 999) } }); (function () {
  ...
  CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
    ...
    function V(a, c, d) { return n(c) && n(d) && d.equals(c.getNext(function (a) { return !(E(a) || F(a) || u(a)) })) } function z(a) { this.upper = a[0]; this.lower = a[1]; this.set.apply(this, a.slice(2)) } function O(a) { var c = a.element; if (c && n(c) && (c = c.getAscendant(a.triggers, !0)) && a.editable.contains(c)) { var d = P(c); if ("true" == d.getAttribute("contenteditable")) return c; if (d.is(a.triggers)) return d } return null } function ka(a, c, d) { r(a, c); r(a, d); a = c.size.bottom; d = d.size.top; return a && d ? 0 | (a + d) / 2 : a || d } function w(a, c, d) {
      ...
      var c = a.doc, d = G('\x3cspan contenteditable\x3d"false" style\x3d"' + Q + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e', c), b = CKEDITOR.getUrl(this.path +
        "img/archive/" + (t.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ? "-rtl" : "") + ".png"); v(d, {
  ...
  }); CKEDITOR.config.plugins = 'dialogui,dialog,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc'; CKEDITOR.config.skin = 'moono'; (function () { var setIcons = function (icons, strip) { var path = CKEDITOR.getUrl('plugins/' + strip); icons = icons.split(','); for (var i = 0; i < icons.length; i++)CKEDITOR.skin.icons[icons[i]] = { path: path, offset: -icons[++i], bgsize: icons[++i] }; }; if (CKEDITOR.env.hidpi) setIcons('copy-rtl,0,,copy,24,,cut-rtl,48,,cut,72,,paste-rtl,96,,paste,120,,horizontalrule,144,,image,168,,indent-rtl,192,,indent,216,,outdent-rtl,240,,outdent,264,,anchor-rtl,288,,anchor,312,,link,336,,unlink,360,,bulletedlist-rtl,384,,bulletedlist,408,,numberedlist-rtl,432,,numberedlist,456,,maximize,480,,pastetext-rtl,504,,pastetext,528,,pastefromword-rtl,552,,pastefromword,576,,removeformat,600,,source-rtl,624,,source,648,,specialchar,672,,scayt,696,,table,720,,redo-rtl,744,,redo,768,,undo-rtl,792,,undo,816,,spellchecker,840,', 'icons_hidpi.png'); else setIcons('copy-rtl,0,auto,copy,24,auto,cut-rtl,48,auto,cut,72,auto,paste-rtl,96,auto,paste,120,auto,horizontalrule,144,auto,image,168,auto,indent-rtl,192,auto,indent,216,auto,outdent-rtl,240,auto,outdent,264,auto,anchor-rtl,288,auto,anchor,312,auto,link,336,auto,unlink,360,auto,bulletedlist-rtl,384,auto,bulletedlist,408,auto,numberedlist-rtl,432,auto,numberedlist,456,auto,maximize,480,auto,pastetext-rtl,504,auto,pastetext,528,auto,pastefromword-rtl,552,auto,pastefromword,576,auto,removeformat,600,auto,source-rtl,624,auto,source,648,auto,specialchar,672,auto,scayt,696,auto,table,720,auto,redo-rtl,744,auto,redo,768,auto,undo-rtl,792,auto,undo,816,auto,spellchecker,840,auto', 'icons.png'); })(); CKEDITOR.lang.languages = { "en": 1 };
}());